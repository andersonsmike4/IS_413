...
def process_request(request, product: cmod.Product):
    ...
    # process the form
        ...
        edit_form = EditForm(request, initial={'name':product.name, 'description':product.description, 'category': product.category.__str__, 'TYPE_CHOICES': product.__class__.__name__, 'status':product.status, 'price':product.price})
